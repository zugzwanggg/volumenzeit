...
const DesignYourWatch = () => {
  return (
    <section className="bg-blue text-white relative py-20">
      ...
      <svg className="absolute -top-1 right-1/2 translate-x-1/2" width="78" height="43" viewBox="0 0 78 43" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path id="Polygon 2" d="M39 43L0.894886 0.25L77.1051 0.249993L39 43Z" fill="white"/>
      </svg>
