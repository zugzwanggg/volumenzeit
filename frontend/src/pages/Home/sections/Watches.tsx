...
const Watches = () => {
  ...
  const sliderPics:string[] = ['black-watch.png','black-watch.png','black-watch.png','black-watch.png','black-watch.png','black-watch.png',];
    ...
    <section className="pt-16">
      <div className="container">
        <div className="text-center">
          <h1>Watches</h1>
          <p className="mt-7">
            Volumenzeit gives you a total of 48 style combinations with 4 <br/> 
            dial types, 4 dial colors, 3 case colors,<br/>
      ...
      >
        ...
        <div className="container flex flex-col items-center gap-7 mt-4 md:mt-24 md:flex-row md:justify-between">
          ...
          <button className="btn-primary bg-blue">
            Design your watch
          </button>
      </div>
      </Swiper>
